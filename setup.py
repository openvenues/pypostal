    ...
    setup(
        ...
        ext_modules=[
            Extension('postal._expand',
                      ...
                      libraries=(["libpostal"] if sys.platform == 'win32' else ["postal"]),
                      include_dirs=['/usr/local/include', './'],
                      library_dirs=['/usr/local/lib', './libpostal/'],
        ...
        data_files=([("postal",["libpostal/libpostal.dll"])] if sys.platform == 'win32' else []),
